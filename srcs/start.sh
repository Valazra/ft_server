...
echo "GRANT ALL ON wordpress.* TO 'vazra'@'localhost' IDENTIFIED BY 'password';" | mysql -u root
...
echo "GRANT ALL ON *.* TO 'vazra'@'localhost' IDENTIFIED BY 'password'" | mysql -u root
echo "FLUSH PRIVILEGES;" | mysql -u root
